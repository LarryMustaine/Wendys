...
public class VideosFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		DB_URL = getActivity().getString(R.string.DB_VIDEOS_URL);
	...
	private void initializeObjects(View rootView) {
		lvVideos = (ListView) rootView.findViewById(R.id.lvGeneric);
	...
	private void configurePull2Refresh() {
        ...
        .listener(new OnRefreshListener() {
			...
			public void onRefreshStarted(View view) {
				if(DataBaseAccess.ifVideosIsEmpty(dbAccess))
	...
	private void populateList() {
		ArrayList<GenericObject> objects = DataBaseAccess.getInfo(dbAccess, WendysSQLite.TABLE_VIDEOS);
		VideosAdapter adapter = new VideosAdapter(getActivity(), objects);
	...
	protected void updateDB() {
		...
		}, WendysSQLite.TABLE_VIDEOS).execute();
	}
